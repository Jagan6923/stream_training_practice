...
const Car1 = () => {
    ...
    return (
        <div className='container mt-5 car-config'>
            ...
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, model: "Nexon" })}>Nexon</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, model: "Punch" })}>Punch</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, model: "Harrier" })}>Harrier</button>
            ...
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, color: "White" })}>White</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, color: "Blue" })}>Blue</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, color: "Black" })}>Black</button>
            ...
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, transmission: "Manual" })}>Manual</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, transmission: "Automatic" })}>Automatic</button>
            ...
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, fuelType: "Petrol" })}>Petrol</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, fuelType: "Diesel" })}>Diesel</button>
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, fuelType: "Electric" })}>Electric</button>
            ...
            <button className='btn btn-primary' onClick={() => setSummary({ ...summary, sunroof: !summary.sunroof })}>
                {summary.sunroof ? "Remove Sunroof" : "Include Sunroof"}
            </button>
